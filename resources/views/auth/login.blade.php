...
<head>
    ...
    <title>Talqen</title>
    <link href="{{asset('uploads/hotels/logoico.ico')}}" rel="icon">
...
<body>
    <div class="forml">
        <div class="form">
            {{-- <img src="{{asset('dashboard_files/image/logo.png')}}" alt="" id="logo"> --}}
            <form action="{{ route('login') }}" method="POST">
                @csrf
                @method("POST")

                <label for="account" style="color:#01008a">Email</label>
                <div class="input-box">
                    <ion-icon class="prefix" name="person-outline"></ion-icon>
                    <input id="account" name="email" type="text" spellcheck="false" />
                </div>
                <label for="password" style="color:#01008a">Password</label>
                <div class="input-box">
                    <ion-icon class="prefix" name="lock-closed-outline"></ion-icon>
                    <input id="password" name="password" type="password" spellcheck="false" />
                    <ion-icon class="switch-btn" name="eye-off-outline" style="color: #2799fa;"></ion-icon>
                </div>
